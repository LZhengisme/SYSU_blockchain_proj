...
class Ui_Bank(object):
    def setupUi(self, Bank):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(80, 260, 321, 21))
        ...
        self.table.setGeometry(QtCore.QRect(60, 90, 351, 151))
        self.table.setObjectName("table")
        self.table.setColumnCount(0)
        self.table.setRowCount(0)
        self.prompt = QtWidgets.QLabel(self.centralwidget)
        self.prompt.setGeometry(QtCore.QRect(140, 50, 201, 31))
    ...
    def retranslateUi(self, Bank):
        ...
        self.prompt.setText(_translate("Bank", "Double-click a row to select"))
